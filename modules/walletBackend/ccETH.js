...
const {CrossChainEthLock, CrossChainEthRedeem, CrossChainEthRevoke} = require('wanchain-js-sdk').CrossChain;
const ccUtil = require('wanchain-js-sdk').ccUtil;

const log = require('../utils/logger').create('cross chain eth');
