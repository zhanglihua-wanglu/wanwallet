...
config.ethLockEventFunc = 'ETH2WETHLock(address,address,bytes32,uint256,address)';
config.wethLockEventFunc = 'ETH2WETHLock(address,address,bytes32,uint256)';
config.wethXeventFunc = 'ETH2WETHRefund(address,address,bytes32,bytes32)';
config.ethRevokeEvent = 'ETH2WETHRevoke(address,bytes32)';
